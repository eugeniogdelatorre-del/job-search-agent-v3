...
export async function GET(req: NextRequest) {
  // Auth gate to match the rest of /api. Status data isn't catastrophic to
  // leak, but unauthenticated polling could be used to fingerprint our cron
  // schedule and there's no reason to allow it.
